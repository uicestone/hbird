(function ($) {
	...
	$(document).ready(function () {
		...
		$(document).on('click', '.insert_marker', function (e) {
			e.preventDefault();
			insert_marker($(this));
		});

		$(document).on('click', '.marker-controls .choose_image', function (e) {
			e.preventDefault();
	...
	function insert_marker($el) {
		...
		html += "<button class='button choose_image'> Choose Image </button>";
	...
	function mapToggleFullWidth() {
		$checkbox = jQuery('#baidu_maps_meta_set_full_width');
		$widthEl = jQuery('#baidu_maps_meta_width');
		$rowToHide = $widthEl.parent().parent();
	...
	function mapUtils() {
		...
		$(document).on('click', '.marker_row_location_grab', function (e) {
			e.preventDefault();
